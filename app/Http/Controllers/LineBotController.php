...
class LineBotController extends Controller
{
    public function reply(Request $request)
    {
		...
		$img_url2 = "https://benbrausen.com/wp-content/uploads/2017/05/HTTPSGuideToGoingSecure-240x240.jpg";

		$imageMessageBuilder = new LINE\LINEBot\MessageBuilder\ImageMessageBuilder($img_url, $img_url2);
